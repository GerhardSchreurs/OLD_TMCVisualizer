...
namespace SharpMik
{
	...
	public class ModuleLoader
	{
		...
		//public static void ProcessMod(Module mod)
  //      {
		//	for (var i = 0; i < mod.positions.Length; i ++)
  //          {
		//		var pattern = new Pattern();
		//		var patternNumber = mod.patterns[i];
		//		var numberOfRows = mod.pattrows[patternNumber];

		//		for (var j = 0; j < numberOfRows; j++)
		//		{
		//			var row = new Row();

		//			var numberOfCols = mod.numchn;
		...
		//	foreach (var position in mod.positions)
  //          {
