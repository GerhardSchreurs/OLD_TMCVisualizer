...
namespace SharpMik.Player
{
    ...
    public class ModPlayer
    {
        ...
        static int Player_GetOrder()
        {
            ...
            Console.WriteLine($"ModPlayer.Player_GetOrder(): {ret}");
        ...
        int Player_GetRow()
        {
            ...
            Console.WriteLine($"ModPlayer.Player_GetRow(): {ret}");
        ...
        {
            Console.WriteLine($"ModPlayer.pt_Notes()");
            ...
            {
                var col = new Col();
                //Console.WriteLine($"ModPlayer.pt_Notes() :: channel = {channel}");
                ...
                if (funky != 0)
                {
                    ...
                    col.anote = a.anote;
                    col.sample = a.main.sample + 1;
                    col.name = s.samplename;


                    //Console.WriteLine($"ModPlayer.pt_Notes() :: a.anote = {a.anote}");
                    //Console.WriteLine($"ModPlayer.pt_Notes() :: a.anote = {s.samplename}");
                    //Console.WriteLine($"ModPlayer.pt_Notes() :: a.anote = {s.handle}");
                    //Console.WriteLine($"ModPlayer.pt_Notes() :: a.anote = {s.speed}");
            ...
            EventInvoker.RaiseOnNewRow(null, row);
        }
        ...
        {
            Console.WriteLine($"ModPlayer.Player_SetPosition(): {pos}");
        ...
        {
            Console.WriteLine($"ModPlayer.Player_Init()");
        ...
        {
            Console.WriteLine($"ModPlayer.Player_Init_internal()");
        ...
        {
            //Console.WriteLine($"ModPlayer.Player_HandleTick()");
            //s_Module = de mod in kwestie
            ...
            //sngpos = pattern
            //Console.WriteLine($"s_Module.sngpos = {s_Module.sngpos}, s_Module.numpos={s_Module.numpos}");
            ...
            {
                //Console.WriteLine($"++s_Module.vbtick >= s_Module.sngspd {s_Module.vbtick} >= {s_Module.sngspd}");
                Console.WriteLine($"ModPlayer.Player_HandleTick() :: s_Module.patpos = {s_Module.patpos}, s_Module.numrow = {s_Module.numrow}");
        ...
        public static int getrandom(int ceil)
        {
            int value = 0;
            if (!s_FixedRandom)
            {
        ...
        public static ushort GetPeriod(ushort flags, ushort note, uint speed)
        {
            if ((flags & SharpMikCommon.UF_XMPERIODS) == SharpMikCommon.UF_XMPERIODS)
            {
