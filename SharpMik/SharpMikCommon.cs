...
/* Used by NNA only player (audio control.  AUDTMP is used for full effects
   control). */
	...
	/* internal module representation */
		...
		{
			Console.WriteLine($"*** Module.AllocSamples() : {numsmp}");
		...
		public void AllocPatterns()
		{
			...
			Console.WriteLine($"*** Module.AllocPatterns() : numchn = {numchn}");
			Console.WriteLine($"*** Module.AllocPatterns() : numpat = {numpat}");
			Console.WriteLine($"*** Module.AllocPatterns() : patterns = {patterns.Length}");
			Console.WriteLine($"*** Module.AllocPatterns() : pattrows = {pattrows.Length}");
		}


		public void AllocTracks()
		{
			Console.WriteLine($"*** Module.AllocPatterns() : {numtrk}");
		...
		{
			Console.WriteLine($"*** Module.AllocInstruments() : {numins}");
